    ...
    HomepageHeading(){
          ...
          <div  
            ...
            <Container textAlign='center'>
              ...
              <Button animated style={{backgroundColor: '#c00031', color:'white', fontFamily: "Effra,Arial,sans-serif", fontSize:'24px',border: '3px, solid, #c00031'}} color='white'   onClick={() => scroll.scrollTo(700)}>
          ...
          <Grid columns={2} stackable>
            ...
            <Grid.Column width='4' textAlign='center'  style={{marginLeft:'16px', paddingBottom: '4em', paddingTop: '5em' }}>
              <Grid.Row textAlign='left' style={{padding:'1em'}}>
                  <Header as='h3' style={{ fontSize: '30px', fontFamily:'Effra,Arial,sans-serif',color:'#c00031',  borderTop: '3px solid #c00031',paddingTop:'10px'}}>
              ...
              <Grid.Row textAlign='center' style={{padding:'1em'}}>
                <Header as='h2' style={{color:'#c00031',fontSize:'32px'}}>  It's fast and secure </Header>
                  
                  
                  <Icon size='large' style={{color:'#c00031'}}name='plus'/>
                  
                  
                  <Header as='h2' style={{color:'#c00031',fontSize:'32px'}}>  There is no impact on your credit to view offers</Header>

              </Grid.Row>*/}
              <Grid.Row textAlign='center' style={{padding:'1em'}}>
                  <Header as='h3' style={{ fontSize: '30px', fontFamily:'Effra,Arial,sans-serif',color:'#c00031'}}>
                    Questions?
                  </Header>
              ...
              <Grid.Row style={{ paddingBottom:'10px',borderBottom: '3px solid #c00031', borderLength:'30px', padding:'1em'}}>
                    ...
                    <div style={{backgroundColor:'#ffffff'}} >
                      <div style={{border:'5px solid',borderColor: '#c00031'}} >
                          ...
                          <Container >
                            ...
                            <Container style={{ borderBottom:'3px solid #c00031', paddingBottom: '20px'}} >
                            <h2 
                            style={{    color: '#c00031',
                              size:'32px',
                              fontWeight: 'bold',
